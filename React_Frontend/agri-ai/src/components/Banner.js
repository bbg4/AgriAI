            ...
            <div className="banner__title">
                ...
                <div className="banner__title_tail">
                    ...
                    <div className="banner__socialMedia">
                        <a className="social_icon_linkedin" href="https://www.linkedin.com/in/balla-bala-ganesh-78674919b/" target="_blank"><span ><i className="fa fa-linkedin" aria-hidden="true"></i></span></a>
                        <a className="social_icon_github" href="https://github.com/balaganesh08" target="_blank"><span><i className="fa fa-github" aria-hidden="true"></i></span></a>
                    </div>
